import { ArrowUpRight, Activity, ShieldCheck, BrainCircuit, Radar, Zap, ScanSearch } from "lucide-react";
    ...
    <main className="zt-home">
      ...
      <section className="zt-how">
        ...
        <div className="zt-pipeline">
          ...
          <div className="zt-step">
            <div className="zt-step-icon"><BrainCircuit /></div>
            <span>04</span>
            <h3>Score</h3>
